  ...
  const handleSubmit = (event) => {
    ...
    return (
      ...
      <Form className="admin" onSubmit={handleSubmit} >
       ...
       {/* Username */}
       <label>Username</label><Field type="text" name="userName" placeholder="Enter your name" value={log.userName} onChange={handleChange} className="form-control" />
        <p className="text-danger"><ErrorMessage name="userName" /></p>

     {/* Password */}
     <label>Password</label><Field type="password" name="password" placeholder="Enter your name" value={log.password} onChange={handleChange} className="form-control" />
